...
Note: The first hout of the lecture lacked video recording.
...
\(G\subseteq\dsP\) is call generic iff
\begin{enumerate}[label={(\alph*)}]
...
Let \(x\subseteq A\), \(x\in M[G]\). We will show that then
\(x\in B = \utilde{B}_G\).
