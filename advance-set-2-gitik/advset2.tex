...
\newcommand{\op}{\ensuremath{\mathop{\rm otpo}\nolimits}}
...
\begin{claim}
\(\forall a\in M[G]\, b\in M[G]\, \cup a \subseteq b\).
\end{claim}
...
Pick \(\utilde{A}\) and
% \seqn{\utilde{x}}
\(\utilde{x_1},\ldots,\utilde{x_2}\)
names such that \(A={\utilde{A}}_G\) and \(x_i={\utilde{x_i}}_G\).
Let
\begin{equation*}
X = \left\{((\utilde{a},p)\,|\, \utilde{a}\in\dom(\utilde{A})\,\wedge\,
  p\in\dsP \,\wedge\,
  p\forces(\utilde{a}\in\utilde{A}) \,\wedge\,
  p\forces \phi(\utilde{a},\utilde{x_1},\ldots,\utilde{x_n})
  \right\}.
\end{equation*}
We will show \(X=\utilde{X_G}\).
...
Since $p$ in a generic set, \(a\in \utilde{X_G}\).

(\(\supseteq\):) Let \(\in \utilde{X_G}\).
