...
\widetilde{g}\left(\widetilde{f}(x)\right)
 ...
 &= \frac{(-1)^k}{2\pi i}
     ...
     \\
 &= (-1)^k(\alpha e -  \widetilde{f}(x))^{-k}
  = (\widetilde{f}(x) - \alpha e)^{-k} \\
...
\widetilde{(g \circ f)}(x)
  ...
  &= (-1)^k(\alpha e - f(x))^{-k} = (f(x) - \alpha e)^{-k}
\end{align*}


Assume $g$ is a rational function (See Theorem~10.25). Then
\begin{align*}
\widetilde{g}\left(\widetilde{f}(x)\right)
 = \frac{1}{2\pi i}\int_{\Gamma_1} g(f(\zeta))(\zeta e - x)^{-1}\,d\zeta
\end{align*}
