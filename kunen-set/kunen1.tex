...
\begin{equation} \label{eq:1.9.40:ReqRstar}
...
Since \(x'Rx\) and $y$ and $s$ are arbitrary \eqref{eq:1.9.40:ReqRn}
and so \eqref{eq:1.9.40:ReqRstar} is proved.

Back to the exercise's last part.  we already shown
\begin{equation*}
\rank_{A,R_1}(y) \leq \rank_{A,R_2}(y) \leq \rank_{A,R_*^*}(y)
\end{equation*}
by \eqref{eq:1.9.40:ReqRn} the last inequalities are actual equalities,
that is \(\rank_{A,R_1}(y) = \leq \rank_{A,R_e2}(y)\).
