...
clearly \(a\neq\emptyset\).
% By Lemma~I.9.14 rank values are oridinals.
By Lemma~I.7.13 union of ordinals that is a set --- is an ordinal.
% and Lemma~I.9.16 there is an ordinal \(\alpha\) % and \(b\in A\) such that
By minimally
\begin{equation*}
\mos(a)
= \{\mos(x): xRa\}
...
\end{equation*}
\iffalse
\{\beta: \beta < \alpha\} = \{\rank(b): bRa\}
and supremum of ordinals equals their union, thus
\begin{equation*}
\rank(a) = \sup\{\rank(x)+1: xRa\}
= \sup\{\mos(x) + 1: xRa\}.
\end{equation*}
\fi
\unfinished
